...
public class ForgeHandOverEvent {
	public static void registerEventsInBus() {
		...
		PlayerInteractEvent.EntityInteractSpecific.BUS.addListener(ForgeHandOverEvent::onPlayerClick);
	}

	@SubscribeEvent
	public static boolean onPlayerClick(PlayerInteractEvent.EntityInteractSpecific e) {
